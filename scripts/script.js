...
/*function bodyHeightEnhancer()
{
    let tutor=document.getElementById("plant_tutor_container")
    let container=document.getElementById("intro_container")
    while (collision(tutor,container))
    {
        let body = document.getElementsByTagName("body")
        body.style.height = "700vh"
    }
}
setInterval(bodyHeightEnhancer(), 1);
